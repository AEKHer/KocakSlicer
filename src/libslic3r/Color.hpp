...
public:
    ...
    static const ColorRGB ORCA()		{ return {220.0f / 255.0f, 38.0f / 255.0f, 38.0f / 255.0f}; }
...
public:
    ...
    static const ColorRGBA ORCA()        { return {220.0f / 255.0f, 38.0f / 255.0f, 38.0f / 255.0f, 1.0f}; }
