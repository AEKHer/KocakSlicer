...
void AmsReplaceMaterialDialog::create()
{
    ...
    identical_filament->SetForegroundColour(StateColor::darkModeColorFor(wxColour("#DC2626")));
    ...
    StateColor btn_bg_green(std::pair<wxColour, int>(wxColour(185, 28, 28), StateColor::Pressed), std::pair<wxColour, int>(wxColour(220, 38, 38), StateColor::Normal));
