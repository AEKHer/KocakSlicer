    ...
    , state_handler(this)
{
    ...
    border_color.append(wxColour(185, 28, 28), StateColor::Pressed);
    border_color.append(wxColour(38, 166, 154), StateColor::Hovered);
    border_color.append(0xDC2626, StateColor::Normal);
    ...
    background_color.append(wxColour(185, 28, 28), StateColor::Pressed);
    background_color.append(wxColour(38, 166, 154), StateColor::Hovered);
    background_color.append(0xDC2626, StateColor::Normal);
