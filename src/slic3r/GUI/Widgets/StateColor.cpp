...
static std::map<wxColour, wxColour> gDarkColors{
    {"#DC2626", "#B91C1C"}, // rgb(220, 38, 38)    KocakSlicer brand color (red)
    ...
    {"#EF4444", "#DC2626"}, // rgb(239, 68, 68)    Button Confirm Color hover | KocakSlicer Color Hover
    ...
    //{"#F0F0F0", "#4C4C54"},
    // ORCA
    {"#F5CCCC", "#3C2222"}, // rgb(245, 204, 204)  Dropdown checked item background color > KocakSlicer color with %25 opacity
    {"#FAE5E5", "#322828"}, // rgb(250, 229, 229)  Combo / Dropdown focused background color > KocakSlicer color with %10 opacity
};
