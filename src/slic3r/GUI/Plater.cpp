...
void Sidebar::priv::flush_printer_sync(bool restart)
{
    ...
    //btn_sync_printer->SetBackgroundColorNormal((*counter_sync_printer & 1) ? "#F8F8F8" :"#DC2626");
...
{
    StateColor not_synced_colour(std::pair<wxColour, int>(wxColour("#DC2626"), StateColor::Normal));
    ...
    : wxPanel(parent, wxID_ANY, wxDefaultPosition, wxSize(42 * wxGetApp().em_unit(), -1)), p(new priv(parent))
{
    ...
    // add printer
    {
        ...
        struct PanelColors {
            ...
            wxColour bd_hover  = "#DC2626";
            wxColour bd_focus  = "#DC2626";
        };
        ...
        */
        ...
        StateColor btn_sync_bd_col(
                std::pair<wxColour, int>(wxColour("#DC2626"), StateColor::Pressed),
                std::pair<wxColour, int>(wxColour("#DC2626"), StateColor::Hovered),
    ...
    text_ctrl->Bind(wxEVT_SET_FOCUS, [this](wxFocusEvent& e) {
        ...
        p->m_search_bar->SetBorderColor(wxColour("#DC2626"));
